 ...
 * 
 * <p> Copyright: Garvit and Manpreet and Lynn Carter © 2017 </p>
 * 
...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	private Label label_DoubleCalculator = new Label("Double Calculator Enhanced");
	...
	private Label label_PlusMinus1 = new Label("\u00B1");	       //The plus minus symbol for opernd1: \u00B1  
	private Label label_PlusMinus2 = new Label("\u00B1");	           //The plus minus symbol for operand2: \u00B1	
	private Label label_PlusMinus3 = new Label("\u00B1");	           //The plus minus symbol for operand2: \u00B1
	...
	private Label label_errOperand1ETerm = new Label(null);                // Label to display specific 
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		// Label the first operand plus minus sign, center aligned
		setupLabelUI(label_PlusMinus1, "Arial", 20, Calculator.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 383, 70);
		...
		setupTextUI(text_Operand1, "Arial", 18, 360, Pos.BASELINE_LEFT, 10, 70, true);
		...
		setupLabelUI(label_errOperand1S, "Arial", 18, Calculator.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 180, 45);
		...
		setupLabelUI(label_PlusMinus2, "Arial", 20, Calculator.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 383, 180);
		// Label the second operand error term, right aligned
		...
		// process both fields to ensure that we are ready to perform as soon as possible.
		setupTextUI(text_Operand2, "Arial", 18, 360, Pos.BASELINE_LEFT, 10, 180, true);
		...
		setupLabelUI(label_errOperand2P, "Arial", 18, Calculator.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 180, 155);
		...
		setupLabelUI(label_errOperand2ETerm, "Arial", 14,  
						Calculator.WINDOW_WIDTH-150-10, Pos.BASELINE_LEFT, 25, 237);		
		...
		setupTextUI(text_Result, "Arial", 18, 360, Pos.BASELINE_LEFT, 10, 290, false);
		// Label the result plus minus sign, center aligned
		setupLabelUI(label_PlusMinus3, "Arial", 20, Calculator.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 383, 290);
		// Label the result error term sign, right aligned
		...
		theRoot.getChildren().addAll(label_DoubleCalculator, label_Operand1, text_Operand1, label_errOperand1, 
				...
				button_Add, button_Sub, button_Mpy, button_Div, button_Sqrt, err1, err2, label_errOperand1S,
				label_errOperand2P,text_Error1, text_Error2, label_Error1, 
				label_Error2, text_ErrorTermResult,label_PlusMinus3, label_ErrorTermResult, 
				err3, label_errOperand1ETerm,err4, label_errOperand2ETerm,
				label_PlusMinus1, label_PlusMinus2);
	}
	...
	**********************************************************************************************/
	...
	private boolean binaryOperandIssuesE() {
		...
		if (label_errOperand1ETerm == null) {
			return false;			
		}
	...
	private void divOperands(){
		...
		// Check to see if both operands are defined and valid
				...
				if (operand2 != 0f ) {                                           // Check if the operand2 is zero or not  
					...
					text_ErrorTermResult.setText("");
					label_errResult.setText(perform.getResultErrorMessage());    // Display the error message.
					label_errOperand2P.setText("Divisor is invalid");             // Display error message if second operand is zero
				}								
	}
