...
public class CalculatorValue {
	...
	**********************************************************************************************/
	...
	public String toString() {
		return checkingUp(measuredValue) + "";
	}
	...
	**********************************************************************************************/
	...
	public void add(CalculatorValue v) {
		double x = Double.parseDouble(errorTerm1);
	    double y = Double.parseDouble(errorTerm2);
		operand1LB = measuredValue - x;
		operand1UB = measuredValue + x;
		operand2LB = v.measuredValue - y;
		operand2UB = v.measuredValue + y;
		
		resultLB = operand1LB + operand2LB;
		resultUB = operand1UB + operand2UB;

		measuredValue =  (resultUB + resultLB)/2;
		errorTerm = Math.abs((resultUB - resultLB)/2);
	...
	public void div(CalculatorValue v) {
		...
		errorTerm = Math.abs((resultUB - resultLB)/2)/2;
	...
	public void sqrt(CalculatorValue v){    
		double x = Double.parseDouble(errorTerm1);                                                
   		errorTerm = Math.abs(0.5 * (x/measuredValue) * Math.sqrt(measuredValue));
