...
public class BusinessLogic {
	...
	**********************************************************************************************/
	...
	CalculatorValue object = new CalculatorValue();
	...
	**********************************************************************************************/
	...
	public boolean setOperand1ET(String value) {
		...
		operand1ET = object.setErrTerm1(value);			// If there was input text, try to convert it into a String
	...
	public boolean setOperand2ET(String value) {
		...
		operand2ET = object.setErrTerm2(value);			// If there was input text, try to convert it into a String
	...
	public boolean setResultET(String value) {				// The logic of this method is similar to setOperand1ET
		...
		resultET = object.setErrTerm(value);
	...
	**********************************************************************************************/
	...
	public String errorTerm() {
		String str = object.toStringErrTerm();
		str = foo(str);
		return str;
	}
